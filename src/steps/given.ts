...
Given('I have logged in to TPN Connect with username {string} and password {string}', async function (username, password) {
    await LoginPage.enterUserName(username);
    await LoginPage.enterPassword(password);
    await LoginPage.clickLogin();
});

Given('I have entered {string} as userName', async function (username) {
    await LoginPage.enterUserName(username);   
});

Given('I have entered {string} as password', async function (password) {   
    await LoginPage.enterPassword(password);    
});
